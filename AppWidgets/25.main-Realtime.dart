...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Realtime'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    _messagesSubscription = _messagesRef.limitToLast(10)
          ...
          children: [
            Flexible(
              child: Center(
                ...
                'Thie includes all devices, ever.',) : 
                Text('Error retrieving button tap count:\n${_error!.message}',),
              ),
            ),
            ElevatedButton(
  ...
  Future<void> _incrementAsTransaction() async {
    final TransactionResult transactionResult = await _counterRef.runTransaction((mutableData) async {
